...
### Passo 6 — Enviar com simulação de digitação humana

```
delay_ms = human_delay_ms(resposta)   ← fórmula: len * 40ms, mín 1500, máx 8000
...
Mesmo fluxo do Modo Reativo passos 4 → 6.
...
### Passo 5 — Resposta validada: enviar ao cliente + documentar
...
|---|---|
| `OBJECTIONS.md` | Novas objeções validadas (automático após aprovação) |
